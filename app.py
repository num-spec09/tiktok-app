        ...
        try:
            ...
            with st.spinner("📝 (1/2) กำลังวิเคราะห์สินค้าและเขียนสคริปต์..."):
                ...
                p_clip = (
                    ...
                    '    {อีก 6 สไตล์โครงเดียวกัน (มี closings + shots): สายให้ความรู้ / สายรีวิวจริงใจ / สายเล่าปัญหา Storytelling / สายกระตุ้นให้รีบซื้อ Urgency / '
                    'สายบอกโปร (เน้นประกาศโปรโมชั่น-ส่วนลด-ของแถม-แพ็กเกจพิเศษ ให้ AI คิดโปรที่เหมาะกับสินค้านี้เองอย่างหลากหลาย เช่น ลดราคา, ซื้อคู่/แถม, ส่งฟรี, ของแถมพิเศษ เลือกแบบที่เข้ากับสินค้าที่สุด) / '
                    'สายเชิญเข้าไลฟ์ (จุดประสงค์ของคลิปนี้คือชวนคนดูไปกดเข้าไลฟ์ ไม่ใช่ปิดการขายในคลิปเลย ให้ AI เลือกเองว่าจะเน้นบอกวัน-เวลาไลฟ์ชวนติดตาม หรือเน้นล่อด้วยโปร/ของพิเศษที่มีเฉพาะในไลฟ์ แล้วแต่ว่าแบบไหนเหมาะกับสินค้านี้ที่สุด)}\n'
                    '  ],\n'
                )
                p_live = (
                    '  "live_scripts": [\n'
                ...
                if want_clip:
                    rules.append("- scripts ครบ 7 เวอร์ชัน (A-G) เนื้อหาต่างกันจริง แต่ละเวอร์ชันมี closings (ปิดการขาย/ปิดท้าย 2-3 ประโยค) และ shots 5 ช็อตของตัวเอง เวลารวม ~45 วินาที "
                                 "เวอร์ชัน F (สายบอกโปร) เน้นประกาศโปรโมชั่นเป็นแกนหลักของสคริปต์ "
                                 "เวอร์ชัน G (สายเชิญเข้าไลฟ์) closings ต้องเป็นประโยคชวนกดเข้าไลฟ์/กดติดตามรอไลฟ์ ไม่ใช่ประโยคปิดการขายแบบสายอื่น")
                if want_live:
